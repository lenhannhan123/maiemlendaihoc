...
@section('title', 'Sửa chuyên ngành mới')
    ...
    <div style="padding: 8% 0%; ">
        ...
        <div class="container">
            <div role="main" class="form-all">
                ...
                <form action="{{ asset('/schoolmajors/edit') }}" style="margin-top: 2%" id="addschool" method="POST"
                        ...
                        <div class="col">
                            <div class="row">
                                ...
                                <div class="col-sm-8">
                                    ...
                                    <input type="text" hidden value="{{ $ds['ID_school_majors'] }}" name="ID_school_majors">
                                    <select name="ID_school" id="ID_school" class="form-control">
                                        <option value="{{ $ds['ID_school'] }}" selected>{{ $ds['name_school'] }}
                                        </option>
                                        @foreach ($school as $item)
                                            @if ($ds['name_school'] != $item['name_school'])
                                                <option value="{{ $item['id_school'] }}">{{ $item['name_school'] }}
                                                </option>
                                            @endif
                                        @endforeach
                                    </select>
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-8">
                                    ...
                                    <select name="ID_group_majors" id="ID_group_majors" class="form-control"
                                        ...
                                        <option value="{{ $ds['ID_group_majors'] }}" selected>{{ $ds['group'] }}
                                        </option>

                                        @foreach ($groupmajors as $item)
                                            @if ($ds['group'] != $item['name'])
                                                <option value="{{ $item['ID_group_major'] }}">{{ $item['name'] }}
                                                </option>
                                            @endif
                                        @endforeach
                        ...
                        <div class="col">
                            <div class="row">
                                ...
                                <div class="col-sm-8">
                                    ...
                                    <select name="ID_majors" id="ID_majors" class="form-control">
                                        <option value="">Vui lòng chọn chuyên ngành</option>

                                        <option value="{{ $ds['ID_majors'] }}" selected>{{ $ds['majors'] }}</option>

                                        @foreach ($majors as $item)
                                            @if ($ds['majors'] != $item['name'] && $item['ID_group_majors'] == $ds['ID_group_majors'])
                                                <option value="{{ $item['ID_majors'] }}">{{ $item['name'] }}</option>
                                            @endif
                                        @endforeach
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-8">
                                    ...
                                    <select name="ID_school_programs" id="ID_school_programs" class="form-control">
                                        <option value="{{ $ds['ID_school_programs'] }}" selected>
                                            {{ $ds['Program_name'] }}
                                        </option>
                                        @foreach ($program as $item)
                                            @if ($ds['Program_name'] != $item['Program_name'])
                                ...
                                <div class="col-sm-10">
                                    ...
                                    <div class="row">
                                        <div class="col-sm-8">
                                            ...
                                            <input type="number" class="form-control" placeholder="Nhập thời gian học"
                                                name="duration" id="duration" required value="{{ $ds['duration'] }}">
                                        </div>
                                        <div class="col-sm-4">
                                    ...
                                    <select name="Pace" id="Pace" class="form-control">
                                        ...
                                        @switch($ds["Pace"])
                                            ...
                                            @case("Bán thời gian")
                                                ...
                                                <option value="Bán thời gian" selected>Bán thời gian</option>
                                    ...
                                    <select name="Teaching_language" id="Teaching_language" class="form-control">
                                        ...
                                        @switch($ds["Teaching_language"])
                                            ...
                                            @case("Việt - Anh")
                                                <option value="Tiếng Việt">Tiếng Việt</option>
                                                <option value="Tiếng Anh">Tiếng Anh</option>
                                                <option value="Việt - Anh" selected>Việt - Anh</option>
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-8">
                                    ...
                                    <select name="study_type" id="study_type" class="form-control">
                                        ...
                                        @switch($ds["study_type"])
                                            @case("Học ở trường")
                                                <option value="Học ở trường"selected>Học ở trường</option>
                                            ...
                                            @case("Học trực tuyến")
                                                ...
                                                <option value="Học trực tuyến" selected>Học trực tuyến</option>
                                ...
                                <div class="col-sm-8">
                                    ...
                                    <div class="row">
                                        <div class="col-sm-8">
                                            ...
                                            <input type="number" class="form-control" placeholder="Nhập học phí"
                                                name="Tuition" id="Tuition" required value="{{ $ds['Tuition'] }}">
                                        </div>
                                        <div class="col-sm-4">
                        ...
                        <div class="col-sm-4">
                            <div class="row">
                                ...
                                <div class="col-sm-10">
                                    ...
                                    <input type="number" class="form-control" placeholder="Nhập điểm chuẩn"
                                        name="benchmark" id="benchmark" required value="{{ $ds['benchmark'] }}">
                                    <div style="color:red">
                            ...
                            <div class="row">
                                <div class="col">
                                    ...
                                    <div class="card-body pad">
                                        <div class="mb-3">
                                            <textarea class="textarea" placeholder="Nhập thông tin" name="text1"
                                                id="text1"
                        ...
                        <div class="col">
                            <div class="row">
                                <div class="col">
                                    ...
                                    <div class="card-body pad">
                                        <div class="mb-3">
                                            <textarea class="textarea" placeholder="Nhập thông tin" name="text2"
                                                id="text2"
                                                style="width: 100%; height: 300px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;">
                                                {{$content["text2"]}}
                                            </textarea>
                        ...
                        <div class="col">
                            <div class="row">
                                <div class="col">
                                    ...
                                    <div class="card-body pad">
                                        <div class="mb-3">
                                            <textarea class="textarea" placeholder="Nhập thông tin" name="text3"
                                                id="text3"
                                                style="width: 100%; height: 300px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;">
                                                {{$content["text3"]}}
                                            </textarea>
                        ...
                        <div class="col">
                            <div class="row">
                                <div class="col">
                                    ...
                                    <div class="card-body pad">
                                        <div class="mb-3">
                                            <textarea class="textarea" placeholder="Nhập thông tin" name="text4"
                                                id="text4"
                                                style="width: 100%; height: 300px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;">
                                                {{$content["text4"]}}
...
{{-- insert link --}}
<script>
     link = {!! json_encode($link->toArray(), JSON_HEX_TAG) !!};
     
    // console.log(link);
    for(i=0;i<link.length;i++){
        addlink();
        document.getElementById("linkyoutube"+(i+1)+"").value=link[i]["link"];
        addifr(i+1);
    }
...
<script>
    ...
    image = {!! json_encode($image->toArray(), JSON_HEX_TAG) !!};
   ...
   for( i=0 ;i<image.length;i++){
       ...
       addimg();
       img= image[i]['Image_name'];
       console.log(img);
        document.getElementById("schoolimg" + (i+1) + "_image").src=`{{ asset('images/imgschoolmajors/`+img+`') }}`;
   }
